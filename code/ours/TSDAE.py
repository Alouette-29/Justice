...
# model_name ="D:/PreTrainedModels/BertCh"
batch_size = 4

#Input file path (a text file, each line a sentence)
if len(sys.argv) < 2:
    print("Run this script with: python {} path/to/train_set.txt".format(sys.argv[0]))
    exit()
...
# dense_model = models.Dense(in_features=768, out_features=384, activation_function=torch.nn.Tanh())
#model = SentenceTransformer(modules=[word_embedding_model, pooling_model, dense_model])
model = SentenceTransformer(model_name_or_path="./output/30000")
