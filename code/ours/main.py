...
def main(args ,modeltype = "basic",collate_fn=collate_fn_1):
    ...
    for e in range(args.ckptepoch,epoch):
        correct = 0
...
if __name__=='__main__':
    ...
    for modeltype in modeltypes:
        #train DPR 
        if args.mode == 'train':
            main(args,modeltype=modeltype,collate_fn=collate_fn_2)
        test_model(f'./model/{args.modelname}_{modeltype}_{args.max_epoch-1}th.model',collate_fn=collate_fn_2)    
