...
class Case():
    ...
    def preprocess(self,clean_set = "../cleanset.txt",string=None):
    ...
    def test_preprocess(self,clean_set = "../cleanset.txt"):
        file = open(clean_set,'r',encoding='utf-8')
        errnum=0 
        wronglog_file = "./wronglog.txt"
        for i in tqdm(range(self.writelines)):
            ...
            try:
                ...
                errnum+=1
                print("\r %d line is wrong "% errnum,end="")
                with open(wronglog_file,'a',encoding='utf-8') as f:
                    f.write(content)
        if errnum==0:
            print("All cases checked, preprocess success")
        else:
            print("%d line is wrong "% errnum,end="")
    # 现在还差一些统计函数
    # string->value 
...
if __name__=='__main__':
    reader = Case('../p2-1-2021/p2-1-2021.txt')
    #reader.preprocess()
